...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Chat.OneMsg> chatContent = getIntent().getParcelableArrayListExtra("chatContent");
        //System.out.println(chatContent.get(0).getChatContent());
        mChat.user=user;
        mChat.chatContent=chatContent;
        ...
        msgAdapter = new MsgAdapter(mChat);
        ...
        send.setOnClickListener(v -> {
                ...
                if(!"".equals(content)){
                    Chat.OneMsg msg =new Chat.OneMsg(user,chatTitle,"text",content,"0");
    ...
    private void initMegs() {
        MsgAdapter adapter=new MsgAdapter(mChat);
        msg_recycle.setAdapter(msgAdapter);
